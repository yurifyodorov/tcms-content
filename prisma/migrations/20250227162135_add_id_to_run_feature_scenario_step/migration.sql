/*
  ...
  - A unique constraint covering the columns `[runId,scenarioId]` on the table `run_scenarios` will be added. If there are existing duplicate values, this will fail.
  ...
  - The required column `id` was added to the `run_scenarios` table with a prisma-level default value. This is not possible if the table is not empty. Please add this column as optional, then populate it before making it required.
...
ADD COLUMN     "id" TEXT NOT NULL,
ADD CONSTRAINT "run_scenarios_pkey" PRIMARY KEY ("id");
